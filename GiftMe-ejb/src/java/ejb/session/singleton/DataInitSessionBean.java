...
*/
    ...
    public void initializePlushies() {
        ...
        Product plushies1 = productControllerLocal.createProduct(new Product(40, "Delightful Teddy", "Let one and all delight on this one cuddly bear that is surprisingly appealing whatever day!", "Plushies", new BigDecimal("20"), "PSH001", "../assets/img/products/PSH001.png", plushRUs));
        Product plushies2 = productControllerLocal.createProduct(new Product(40, "Cheery Teddy", "Compel your darling’s day to be extra cheerful by giving her Christie, this enthusiastic bear!", "Plushies", new BigDecimal("25"), "PSH002", "../assets/img/products/PSH002.png", plushRUs));
        Product plushies3 = productControllerLocal.createProduct(new Product(40, "Married Bears", "This pair of couple cuddly bears is perfect as the gift for the newlywed! ", "Plushies", new BigDecimal("30"), "PSH003", "../assets/img/products/PSH003.png", plushRUs));
        Product plushies4 = productControllerLocal.createProduct(new Product(40, "Comfort Bear", "Wish your loved ones a speedy recovery with this Get Well Soon cuddly bear!", "Plushies", new BigDecimal("28"), "PSH004", "../assets/img/products/PSH004.png", plushRUs));
        Product plushies5 = productControllerLocal.createProduct(new Product(40, "Basic Bear", "All the soft toy lovers out there are bound to love some cuddly bears! What’s more, the arms and legs of these bears are sewn in such a way that they are movable!", "Plushies", new BigDecimal("26"), "PSH005", "../assets/img/products/PSH005.png", teddyLodge));
        Product plushies6 = productControllerLocal.createProduct(new Product(40, "Knitted Sheep", "This handmade knitted plushy is sure to melt some hearts. Surprise your loved ones with this snuggly sheep today!", "Plushies", new BigDecimal("30"), "PSH006", "../assets/img/products/PSH006.png", teddyLodge));
        Product plushies7 = productControllerLocal.createProduct(new Product(40, "Furry Bear", "We all need a furry teddy bear in our soft toy collection. This huggable soft toy is definitely a hot favourite!", "Plushies", new BigDecimal("30"), "PSH007", "../assets/img/products/PSH007.png", teddyLodge));
        Product plushies8 = productControllerLocal.createProduct(new Product(40, "Happy Kangaroo", "These handmade knitted kangaroos come in a pair. Bonus- the baby kangaroo fits in the pouch of mama kangaroo! ", "Plushies", new BigDecimal("35"), "PSH008", "../assets/img/products/PSH008.png", teddyLodge));
        Product plushies9 = productControllerLocal.createProduct(new Product(40, "Red polka-dot bear", "Let this adorable cuddly buddy bring a smile into your love ones face. What’s more, the arms and legs of these bears are sewn in such a way that they are movable!", "Plushies", new BigDecimal("23"), "PSH009", "../assets/img/products/PSH009.png", teddyLodge));
        Product plushies10 = productControllerLocal.createProduct(new Product(40, "Floral Bear", "All the soft toy lovers out there are bound to love some cuddly bears! What’s more, the arms and legs of these bears are sewn in such a way that they are movable!", "Plushies", new BigDecimal("23"), "PSH010", "../assets/img/products/PSH010.png", teddyLodge));
